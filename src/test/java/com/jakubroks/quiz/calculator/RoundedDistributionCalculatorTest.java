...
class RoundedDistributionCalculatorTest {

    private RoundedDistributionCalculator calculator;

    @BeforeEach
    void setUp() {
        calculator = new RoundedDistributionCalculator();
    }

    @Test
    void givenTotal6AndRatio132_whenCalculating_thenSplitIsExact() {
        int total = 6;
    ...
    @Test
    void givenTotal8AndRatio132_whenCalculating_thenRoundingIsApplied() {
        int total = 8;
    ...
    @Test
    void givenTotal7AndRatio132_whenCalculating_thenSumEqualsTotal() {
        int total = 7;
